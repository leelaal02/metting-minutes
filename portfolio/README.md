...
| 실적 | 구조가 서로 다른 양식 **5종**(회사 3종 · 자체 검증 2종)을 코드 수정 **0줄**로 지원 · 테스트 **186개** 통과 |
...
| 4 | [`docs/superpowers/`](../docs/superpowers) — 코드를 쓰기 전에 남긴 설계서 6건·구현 계획 3건 (저장소 루트) | 필요할 때 |
...
| 폴더 | 내용 |
|---|---|
| `docs/superpowers/specs/` | 무엇을 왜 만드는지 · 확정한 설계 결정과 근거 **6건** |
| `docs/superpowers/plans/` | 그 설계를 어떤 순서로 구현할지 **3건** |
